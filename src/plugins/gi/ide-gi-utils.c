                                               ...
                                               gpointer             user_data)
{
  ...
  ide_task_set_task_data (task, state, (GDestroyNotify)from_directories_state_free);
                                             ...
                                             gpointer             user_data)
{
  ...
  ide_task_set_task_data (task, state, (GDestroyNotify)from_directory_state_free);
                                     ...
                                     gpointer             user_data)
{
  ...
  ide_task_set_task_data (task, state, (GDestroyNotify)remove_state_free);
