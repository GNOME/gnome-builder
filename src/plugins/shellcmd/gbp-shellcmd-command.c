...
static void
gbp_shellcmd_command_run (GbpShellcmdCommand    *self,
                               ...
                               IdeTask             *task)
{
  ...
  gbp_shellcmd_command_run (self, launcher, workdir, task);
}
                                ...
                                IdeTask             *task)
{
  ...
  gbp_shellcmd_command_run (self, launcher, builddir, task);
}
