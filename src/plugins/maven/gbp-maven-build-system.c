...
static void
gbp_maven_build_system_destroy (IdeObject *object)
{
  GbpMavenBuildSystem *self = (GbpMavenBuildSystem *)object;

  g_clear_object (&self->project_file);

  IDE_OBJECT_CLASS (gbp_maven_build_system_parent_class)->destroy (object);
}
...
gbp_maven_build_system_class_init (GbpMavenBuildSystemClass *klass)
{
  ...
  i_object_class->destroy = gbp_maven_build_system_destroy;
