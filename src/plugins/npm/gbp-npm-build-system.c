...
static void
gbp_npm_build_system_destroy (IdeObject *object)
{
  GbpNpmBuildSystem *self = (GbpNpmBuildSystem *)object;

  g_clear_object (&self->project_file);

  IDE_OBJECT_CLASS (gbp_npm_build_system_parent_class)->destroy (object);
}
...
gbp_npm_build_system_class_init (GbpNpmBuildSystemClass *klass)
{
  ...
  i_object_class->destroy = gbp_npm_build_system_destroy;
