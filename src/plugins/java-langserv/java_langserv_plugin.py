...
class JavaService(Ide.Object, Ide.Service):
    ...
    * We could offload these messages to `JavaStatusMessage()` (Yet to be implemented, See below)
      which is a jdt language server extension (https://github.com/eclipse/eclipse.jdt.ls/wiki/Language-Server-Protocol-Extensions)
    """
    ...
    * Also we probably need more error checking here, perhaps we could push this logig
    ...
    def find_launcher(self, server_path):
        ...
        path = os.path.join(exe_path, launcher[0])
