...
static void
spellcheck_before_insert_text (GtkTextBuffer *buffer,
                               guint          offset,
                               guint          length,
                               gpointer       user_data)
{
...
static void
spellcheck_after_insert_text (GtkTextBuffer *buffer,
                              guint          offset,
                              guint          length,
                              gpointer       user_data)
{
...
static void
spellcheck_before_delete_range (GtkTextBuffer *buffer,
                                guint          offset,
                                guint          length,
                                gpointer       user_data)
{
...
static void
spellcheck_after_delete_range (GtkTextBuffer *buffer,
                               guint          offset,
                               guint          length,
                               gpointer       user_data)
{
