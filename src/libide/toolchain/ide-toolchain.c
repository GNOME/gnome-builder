 ...
 * @self: an #IdeToolchain
 *
 * Gets the host system of the toolchain
 *
 * Returns: (nullable) (transfer none): The host system or %NULL.
 *
 * Since: 3.30
 */
const gchar *
 ...
 * @self: an #IdeToolchain
 * @host_system: (nullable): the host system of the toolchain
 *
 ...
 *
 * Returns: (nullable) (transfer none): The host architecture or %NULL.
 *
 * Since: 3.30
 */
const gchar *
 ...
 * @self: an #IdeToolchain
 * @host_architecture: (nullable): the host architecture of the toolchain
 *
...
ide_toolchain_class_init (IdeToolchainClass *klass)
{
  ...
  properties [PROP_HOST_SYSTEM] =
    g_param_spec_string ("host-system",
                         "Host system",
                         "The system name of the machine on which the compiled binary will run",
                         NULL,
  ...
  properties [PROP_HOST_ARCHITECTURE] =
    g_param_spec_string ("host-architecture",
                         "Host architecture",
                         "The architecture of the machine on which the compiled binary will run",
                         NULL,
                         (G_PARAM_READABLE | G_PARAM_CONSTRUCT | G_PARAM_STATIC_STRINGS));
