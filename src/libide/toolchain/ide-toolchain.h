...
IDE_AVAILABLE_IN_3_30
const gchar   *ide_toolchain_get_host_kernel        (IdeToolchain           *self);
IDE_AVAILABLE_IN_3_30
void           ide_toolchain_set_host_kernel        (IdeToolchain           *self,
...
IDE_AVAILABLE_IN_3_30
gchar         *ide_toolchain_get_host_system_type   (IdeToolchain           *self);
IDE_AVAILABLE_IN_3_30
