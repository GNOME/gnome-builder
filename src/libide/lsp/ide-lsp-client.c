                               ...
                               gpointer      user_data)
{
  ...
  if (!jsonrpc_client_send_notification_finish (priv->rpc_client, result, &error))
    g_debug (_("Failed send initialized notification to language server: %s"), error->message);
