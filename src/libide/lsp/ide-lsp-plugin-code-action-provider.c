...
{
  IdeLspPluginCodeActionProviderClass *klass = (IdeLspPluginCodeActionProviderClass *)(((GTypeInstance *)provider)->g_class);
  ...
  if G_UNLIKELY (info->code_action_provider_type == G_TYPE_INVALID)
    {
      ...
      g_type_add_interface_static (info->code_action_provider_type,
                                   ...
                                   &(GInterfaceInfo) {
                                     (GInterfaceInitFunc)(void (*) (void))ide_lsp_plugin_code_action_provider_iface_init,
                                     NULL,
                                     NULL,
                                   });
    }
