...
SRC = "src/patterns.svg"
PREFIX = "hicolor/98x98"
...
def chopSVG(icon)
	...
	unless (File.exists?(icon[:file]) && !icon[:forcerender])
		...
		cmd += "--verb=EditDelete --verb=EditSelectAll --verb=SelectionUnGroup --verb=SelectionUnGroup --verb=SelectionUnGroup --verb=FileVacuum "
