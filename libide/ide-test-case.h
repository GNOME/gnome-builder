...
#define IDE_TEST_CASE(obj)               (G_TYPE_CHECK_INSTANCE_CAST ((obj), IDE_TYPE_TEST_CASE, IdeTestCase))
#define IDE_IS_TEST_CASE(obj)            (G_TYPE_CHECK_INSTANCE_TYPE ((obj), IDE_TYPE_TEST_CASE))
#define IDE_TEST_CASE_GET_INTERFACE(obj) (G_TYPE_INSTANCE_GET_INTERFACE ((obj), IDE_TYPE_TEST_CASE, IdeTestCaseInterface))
