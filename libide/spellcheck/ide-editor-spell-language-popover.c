/* ide-editor-spell-language-popover.c
 *
...
struct _IdeEditorSpellLanguagePopover
{
...
static void ide_editor_spell_language_popover_language_chooser_iface_init (GspellLanguageChooserInterface *iface);

G_DEFINE_TYPE_WITH_CODE (IdeEditorSpellLanguagePopover, ide_editor_spell_language_popover, GTK_TYPE_BUTTON,
                         G_IMPLEMENT_INTERFACE (GSPELL_TYPE_LANGUAGE_CHOOSER, ide_editor_spell_language_popover_language_chooser_iface_init))
...
IdeEditorSpellLanguagePopover *
ide_editor_spell_language_popover_new (const GspellLanguage *current_language)
{
  return g_object_new (IDE_TYPE_EDITOR_SPELL_LANGUAGE_POPOVER,
                       "language", current_language,
                       NULL);
}

static void
scroll_to_selected (IdeEditorSpellLanguagePopover *self)
{
  GtkTreeIter iter;
  GtkTreePath *path;
...
static void
populate_popover (IdeEditorSpellLanguagePopover *self)
{
...
static void
ide_editor_spell_language_popover_treeview_row_activated_cb (IdeEditorSpellLanguagePopover *self,
                                                             GtkTreePath                   *path,
...
static GtkPopover *
create_popover (IdeEditorSpellLanguagePopover *self)
{
  GtkPopover *popover;
  ...
  g_signal_connect_object (self->treeview,
                           "row-activated",
                           G_CALLBACK (ide_editor_spell_language_popover_treeview_row_activated_cb),
                           self,
                           G_CONNECT_SWAPPED);
...
static void
select_language (IdeEditorSpellLanguagePopover *self,
                 const GspellLanguage          *language)
{
...
static void
ide_editor_spell_language_popover_button_clicked (GtkButton *button)
{
  IdeEditorSpellLanguagePopover *self = (IdeEditorSpellLanguagePopover *)button;
...
static void
update_button_label (IdeEditorSpellLanguagePopover *self)
{
  g_assert (IDE_IS_EDITOR_SPELL_LANGUAGE_POPOVER (self));
...
static void
ide_editor_spell_language_popover_set_language (GspellLanguageChooser *chooser,
                                                const GspellLanguage  *language)
{
  IdeEditorSpellLanguagePopover *self = (IdeEditorSpellLanguagePopover *)chooser;
...
ide_editor_spell_language_popover_get_language_full (GspellLanguageChooser *chooser,
...
static void
ide_editor_spell_language_popover_finalize (GObject *object)
{
  IdeEditorSpellLanguagePopover *self = (IdeEditorSpellLanguagePopover *)object;
...
static void
ide_editor_spell_language_popover_get_property (GObject    *object,
                                                guint       prop_id,
                                                GValue     *value,
                                                GParamSpec *pspec)
{
...
static void
ide_editor_spell_language_popover_set_property (GObject      *object,
                                                guint         prop_id,
                                                const GValue *value,
                                                GParamSpec   *pspec)
{
...
static void
ide_editor_spell_language_popover_constructed (GObject *object)
{
  G_OBJECT_CLASS (ide_editor_spell_language_popover_parent_class)->constructed (object);

  update_button_label (IDE_EDITOR_SPELL_LANGUAGE_POPOVER (object));
}

static void
ide_editor_spell_language_popover_map (GtkWidget *widget)
{
  IdeEditorSpellLanguagePopover *self = (IdeEditorSpellLanguagePopover *)widget;
  IdeWorkbench *workbench;
  GtkWidget *edge;

  GTK_WIDGET_CLASS (ide_editor_spell_language_popover_parent_class)->map (widget);
...
static void
ide_editor_spell_language_popover_class_init (IdeEditorSpellLanguagePopoverClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);
  GtkWidgetClass *widget_class = GTK_WIDGET_CLASS (klass);
  GtkButtonClass *button_class = GTK_BUTTON_CLASS (klass);

  object_class->finalize = ide_editor_spell_language_popover_finalize;
  object_class->get_property = ide_editor_spell_language_popover_get_property;
  object_class->set_property = ide_editor_spell_language_popover_set_property;
  object_class->constructed = ide_editor_spell_language_popover_constructed;

  widget_class->map = ide_editor_spell_language_popover_map;
  button_class->clicked = ide_editor_spell_language_popover_button_clicked;
...
static void
ide_editor_spell_language_popover_init (IdeEditorSpellLanguagePopover *self)
{
  self->edge_side = -1;
}

static void
ide_editor_spell_language_popover_language_chooser_iface_init (GspellLanguageChooserInterface *iface)
{
  iface->get_language_full = ide_editor_spell_language_popover_get_language_full;
  iface->set_language = ide_editor_spell_language_popover_set_language;
}
